...
--
-- Host: mariadb:3306
-- Erstellungszeit: 28. Feb 2025 um 10:53
...
CREATE TABLE `kommentar` (
  ...
  `Zeitstempel` varchar(19) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `kommentar` (`Kommentar_id`, `user_id`, `Ticket_id`, `Nachricht`, `Zeitstempel`) VALUES
(17, 5, 7, 'Tabelle wird im falschen div Container angezeigt. Behebung erfolgt morgen', '28.02.2025 11:52:55');
...
--
-- Daten für Tabelle `prio`
--

INSERT INTO `prio` (`Prio_id`, `anzeigename`) VALUES
(0, 'Niedrig'),
(1, 'Mittel'),
(2, 'Hoch');
...
INSERT INTO `status` (`status_id`, `anzeigename`) VALUES
(0, 'Neu'),
(1, 'Bearbeitung'),
(2, 'Erledigt');
...
(7, 4, 'Tabelle wird nicht angezeigt', 'Hallo, bei mir wird die Tabelle nicht korrekt angezeigt. Bitte prüft das nochmal. Danke!', 1, 1, 1, '28.02.2025', 112),
(8, 3, 'Bild lädt nicht', 'Das Bild bei der Login Seite wird nicht angezeigt. Bitte prüfen', 0, 0, 1, '28.02.2025', 113),
(9, 7, 'Login geht nicht', 'Der Login Funktioniert nicht, es wird immer eine Fehlermeldung angezeigt', 0, 2, 2, '28.02.2025', 112),
(10, 5, 'Zugang auf Pi nicht möglich', 'Ich komme auf den Rasberry Pi nicht drauf.', 0, 0, 3, '28.02.2025', 114),
(11, 8, 'Git-Problem', 'Kann mich im Git Hub nicht anmelden', 0, 2, 3, '28.02.2025', 112);
...
(3, 'Ben Gieseler', '', '', 2, 0, NULL),
(4, 'Paul Doil', '', '', 2, 0, NULL),
(5, 'Kimi Emmrich', '', '', 2, 0, NULL),
(6, 'Sophie', '', '', 2, 0, NULL),
(7, 'Maximilian', '', '', 2, 0, NULL),
(8, 'Pascal', '', '', 2, 0, NULL);
...
--
ALTER TABLE `prio`
  MODIFY `Prio_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `user_data`
  MODIFY `Benutzer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
